...
const CUISINE_OPTIONS = {
  restaurant: [
    ...
    { id: 'japanese',      emoji: '🍣', label_de: 'Japanisch',        label_en: 'Japanese' },
    { id: 'korean',         emoji: '🥢', label_de: 'Koreanisch',        label_en: 'Korean' },
    { id: 'chinese',        emoji: '🥡', label_de: 'Chinesisch',        label_en: 'Chinese' },
    { id: 'thai',           emoji: '🍛', label_de: 'Thailändisch',      label_en: 'Thai' },
    { id: 'vietnamese',     emoji: '🍜', label_de: 'Vietnamesisch',     label_en: 'Vietnamese' },
